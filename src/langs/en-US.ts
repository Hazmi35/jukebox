...
export const lang = {
    ...
    COMMAND_PLAY_YOUTUBE_PLAYLIST_ADDING_VIDEOS_FROM: (videoTitle: string, playlistTitle: string) => `Adding all tracks starting from track: ${videoTitle} in playlist: ${playlistTitle}, hang on...`,
    COMMAND_PLAY_YOUTUBE_PLAYLIST_ADDING_ALL_VIDEOS: (playlistTitle: string) => `Adding all tracks in playlist: ${playlistTitle}, hang on...`,
    COMMAND_PLAY_YOUTUBE_PLAYLIST_ADDING_FIRST_VIDEOS_ERR: (playlistTitle: string) => `⚠️ Could not add the first video of the playlist: ${playlistTitle}`,
