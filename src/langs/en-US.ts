...
export const lang = {
    ...
    COMMAND_PLAY_YOUTUBE_PLAYLIST_NOT_FOUND: () => "⚠️ Playlist not found",
    COMMAND_PLAY_YOUTUBE_PLAYLIST_EMPTY: () => "⚠️ The specified playlist is empty.",
    COMMAND_PLAY_YOUTUBE_RD_PLAYLIST_NOT_SUPPORTED: () => "⚠️ RD / YouTube mix playlist is not supported yet. Please see [this issue](https://github.com/Hazmi35/jukebox/issues/594)",
    COMMAND_PLAY_YOUTUBE_PLAYLIST_ADDING_VIDEOS: (index: number, playlistTitle: string) => `Adding all tracks starting from number ${index} video in playlist: ${playlistTitle}, hang on...`,
    COMMAND_PLAY_YOUTUBE_PLAYLIST_ALL_ADDING_VIDEOS: (playlistTitle: string) => `Adding all tracks in playlist: ${playlistTitle}, hang on...`,
    COMMAND_PLAY_YOUTUBE_PLAYLIST_ADDING_FIRST_VIDEOS_ERR: () => "⚠️ Could not add the first video of the playlist",
    COMMAND_PLAY_YOUTUBE_PLAYLIST_ADDING_REST_VIDEOS_ERR: () => "⚠️ Could not add the rest videos of the playlist",
    ...
    COMMAND_PLAY_YOUTUBE_SEARCH_RESULTS_CANCEL_MSG: () => "Type `cancel` or `c` to cancel tracks selection",
